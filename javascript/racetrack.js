...
class Audio {
    constructor() {
        ...
        let _self = this;
        this.play(ASSETS.AUDIO.theme, "theme", function (key) {
...
if (use && lines[endPos].y !== 0) {
    ...
    speed = accelerate(speed, -20, step); // You can adjust the value -20 to control the amount of speed reduction
}
...
function init() {
    ...
    let farewell = new Audio('bgmusic/Farewell.mp3')
    farewell.play()
    ...
    cars.push(new Car(N, ASSETS.IMAGE.CAR, LANE.A));
...
// var songMenu = document.getElementById('diffMenu');

//   // Add an event listener to the select element
//   songMenu.addEventListener('change', function() {
//       // Get the selected option
//       var selectedOption = diff.options[songMenu.selectedIndex];

//       // Check if the selected option is "Farewell"
//       if (selectedOption.value === 'hard') {
//           // Change the value of the variable N to 30
//           var N = 30;
//           init();
//           // console.log('N has been set to 30 because Farewell is selected.');
//       }
//   });
init();

var diffMenu = document.getElementById('diffMenu');
var valueOfNElement = document.getElementById('valueOfN');

// Add an event listener to the select element
diffMenu.addEventListener('change', function () {
    // Get the selected option
    var selectedOption = diffMenu.options[diffMenu.selectedIndex];

    // Check if the selected option is "Farewell"
    if (selectedOption.value === 'hard') {
        // Change the value of the variable N to 30
        cars.push(new Car(30, ASSETS.IMAGE.CAR, LANE.A));
        cars.push(new Car(25, ASSETS.IMAGE.CAR, LANE.B));
        cars.push(new Car(15, ASSETS.IMAGE.CAR, LANE.A));
    ...
    // valueOfNElement.textContent = 'The value of N is: ' + cars.length;
});
